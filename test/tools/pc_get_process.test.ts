...
describe("pc_get_process", () => {
  ...
  it("returns suggestions when target is not found", async () => {
    ...
    const result = await handleToolCall(client, "pc_get_process", { name: "missing" });
